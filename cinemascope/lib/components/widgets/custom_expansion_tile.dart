...
const CustomExpansionTileDecoration _customExpansionTileDecorationLight =
  ...
  expandedTitleColor: Color(0xff303030),
  // 424242 (lighter)
  ...
  expandedBodyColor: const Color(0xfff5f5f5),
  // eeeeee (darker)
  borderWidth: 0.4,
...
const CustomExpansionTileDecoration _customExpansionTileDecorationDark =
    CustomExpansionTileDecoration(
  collapsedBorderColor: const Color(0xFF303030),
  // collapsedHeaderColor: const Color(0x61000000),
  expandedHeaderColor: const Color(0xff000000),
  // expandedHeaderColor: const Color(0xFF303030),
  collapsedBodyColor: const Color(0xffe0e0e0),
  expandedBorderColor: const Color(0xFF303030),
  expandedBodyColor: const Color(0xff424242),
  collapsedTitleColor: const Color(0xffbdbdbd),
  expandedTitleColor: const Color(0xffeeeeee),
  expandedIconColor: const Color(0xffe0e0e0),
...
class _CustomExpansionTileState extends State<CustomExpansionTile>
    with SingleTickerProviderStateMixin<CustomExpansionTile> {
  ...
  void didChangeDependencies() {
    ...
    _borderColorTween
      ...
      ..end =
          decoration?.expandedBorderColor ?? decoration?.collapsedBorderColor ?? theme.dividerColor;
    _headerColorTween
      ...
      ..end = widget?.decoration?.expandedHeaderColor ??
          ...
          Colors.transparent;
    _titleColorTween
      ..begin = decoration?.collapsedTitleColor ?? theme.textTheme.subtitle1.color
    ...
    _bodyColorTween
      ...
      ..end = decoration?.expandedBodyColor ?? decoration?.collapsedBodyColor ?? Colors.transparent;
